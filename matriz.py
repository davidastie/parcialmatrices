...
class Matriz(object):
    ...
    def __init__(self, filas=None, columnas=None):
        ...
        if filas:
            ...
            self.filas=int(raw_input(" Por favor ingrese el numero de filas "))
        if columnas:
            self.columnas= columnas
        else:
            self.columnas = int(raw_input(" Por favor ingrese el numero de columnas "))
    ...
    def matriz_inversa(self,matriz):
        ...
        if (self.filas != self.columnas):
            print " La matriz tiene que ser cuadrada para realizar la operacion "
    ...
    def matriz_numero(self):
            ...
            for f in range(self.columnas):
                self.matrizB.append([0] * self.filas)
            a = int(raw_input("Por favor ingrese un numero "))
            for i in range(self.filas):
                for j in range(self.columnas):
    ...
    def matriz_elevada(self):
        ...
        a = int(raw_input("Por favor ingrese el numero que desea a elevar "))
    ...
    def matrizSimetrica(self):
        ...
        for f in range(self.filas):
            auxiliar = []
            for c in range(self.columnas):
                elemento = int(raw_input(" Por favor ingrese %d, %d: " % (f, c)))
...
class Menu(object) :
    ...
    def __init__(self, prompt="Selecione la opcion que desea ejecutar \n>> ") :
        ...
        self.opciones = [
            ...
            self.opcion_Matriz_Inversa,
            self.opcion_Matriz_Transpuesta,
            self.opcion_Matriz_Escalar,
            self.opcion_Matriz_Elevada,
            self.opcion_Matriz_Simetrica,
            self.opcion_Matriz_Identica,
    ...
    def opcion_Matriz_Determinante(self):
        pass
    def opcion_Matriz_Inversa(self):
        pass
    def opcion_Matriz_Transpuesta(self):
        pass
    def opcion_Matriz_Escalar(self):
        pass
    def opcion_Matriz_Elevada(self) :
        pass
    def opcion_Matriz_Simetrica(self) :
        pass
    def opcion_Matriz_Identica(self) :
        pass
